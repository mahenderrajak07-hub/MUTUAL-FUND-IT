...
function buildReport(funds, results, knowledge) {
  ...
  return {
    ...
    sectors,
    overlap:{overallPct,verdict:knowledge?.overlap?.verdict||(funds.length>4?'Critical redundancy — multiple funds, one strategy':'Moderate overlap — consolidate'),topStocks},
